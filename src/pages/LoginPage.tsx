      ...
      <div className="w-full max-w-md mx-auto p-6">
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          ...
          <button
            ...
            disabled={isSubmitting}
            className="w-full py-2.5 bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 disabled:bg-gray-100 disabled:cursor-not-allowed rounded-md font-medium transition-colors flex items-center justify-center gap-2"
          >
